...
export default function RegisterPage() {
    ...
    const getPasswordStrength = (password: string) => {
        ...
        if (password.length > 0 && password.length <= 6) return {text: "Weak", color: "text-red-500"};
        return {text: "", color: ""};
    }
                        ...
                        <div className="space-y-2">
                            ...
                            {formData.password && (
                                <div className="text-sm font-medium mt-1">
                                    <span className={passwordStrength.color + " font-semibold"}>{passwordStrength.text}</span>
                                </div>
                            )}
                        </div>
